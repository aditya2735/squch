    ...
    <div className='card card-traveling position-relative card-change-detail mb-40'>
               <div className='d-flex align-items-center card-head-box'>
                   <div className='me-auto'>
                       <h2 className='ttl-traveling'>Squch Assurance</h2>
                       <p>₵8 Per Passenger</p>
                   </div>
                   ...
                   <div className="d-md-flex gap-32">
                       <div className="flex-grow-1">
                           ...
                           <div className="card-gray">
                                <p className="m-0">if your bus gets cancelled, you get</p>
                               <h2 className="green-wedge-text">₵ 180</h2>
                               <p className="m-0">₵172 + ₵8(extra cashback)</p>
                           </div>
                               ...
                               <ul className="list-unstyled m-0">
                                   <li>
                                       <div className="d-flex align-items-center">
                                           <div className="me-auto">
                                               <h3 className="passenger-ttl">For this and future booking</h3>
                                   ...
                                   <li>
                                       <div className="d-flex align-items-center">
                                           <div className="me-auto">
                                               <h3 className="passenger-ttl">Add Squch Assurance</h3>
                                               <p>Only for ₵8 per passenger</p>
                                           </div>
                                           <div className="ms-auto">
                                           <label className="radio-round">
                                           <input type="radio" name="radio" />
                                   ...
                                   <li>
                                       <div className="d-flex align-items-center">
                                           <div className="me-auto">
                                               <h3 className="passenger-ttl">I don’t Want any assurance</h3>
                                           </div>
                                           <div className="ms-auto">
                                           <label className="radio-round">
                                           <input type="radio" name="radio" />
