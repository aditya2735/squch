            ...
            <div className='map'>
                ...
                <div className='card card-sav-location'>
                        ...
                        <div className='d-md-flex align-items-center'>
                            <div className='flex-grow-1 d-flex align-items-center'>
                                ...
                                <div className='flex-grow-1'>
                                    <h3 className='location-ttl'>{locationAddress?.address?.county || "Fetching location..."}</h3>
                                    <p className='m-0'>{locationAddress?.display_name || "Loading address..."}</p>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className='message-warning'>
                        <p className='m-0'>A detailed address will help our Delivery Partner reach your doorstep easily</p>
                    </div>

                    {/* Show loader if still fetching location, else show form */}

                    <DataLoader loading={isLoading} error={error} retryFunction={fetchLocation}>
                    {(locationAddress && location?.lat && location?.lon ) && <AddressForm address={locationAddress.address} location={location}/>}
