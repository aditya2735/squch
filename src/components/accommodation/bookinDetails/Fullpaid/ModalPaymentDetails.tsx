...
import SquchmartPaymentSuccessful from './SquchmartPaymentSuccessful';


const ModalPaymentDetails = ({ show, handleClose }: any) => {
    ...
    return (
        <div>
            <Modal show={show} onHide={handleClose} centered className="modal-filter modal-conform-payment details pt-4">
                <Modal.Header>
                ...
                <Modal.Body className="filter-modal-body">
                    <div className='modal-block-header'>
                        ...
                        <p>We recommended to pay before you checking to get extra discount and offers, also on prepaid bookings if you were late on check-in we won’t allot your room to someone else.</p>
                    </div>

                    <div className='sec-credit-card-details'>
                        <div className='payment-mode'>
                            <div className='payment-mode-ttl'>Payment Mode</div>
                ...
                <Modal.Footer className="modal-footer-box">
                    <button className='btn btn-primary w-100' onClick={() => {handleClose(); setShowCancelConfirmation(true); }}>Confirm & Pay  ₵ 1750</button>
                </Modal.Footer>
            </Modal>

            <SquchmartPaymentSuccessful show={showCancelConfirmation} handleClose={() => setShowCancelConfirmation(false)}/>
        </div>
    )
}
