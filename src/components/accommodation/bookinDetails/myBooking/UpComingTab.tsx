...
const UpComingTab = () => {
  ...
  const handleHotelNav = (item: MyBooking) => {
    ...
    router.push(`/home/accommodation/details/${hotelId}/booking`);
  };
  ...
  return (
    <div className="row">
      {upcoming?.length > 0 &&
        upcoming.map((item) => {
          const {id, name, address, city, state, country, latitude, longitude,isDateChangeAvailable,refundableTill } =
            item.hotel;
          const { paymentStatus, startDate,endDate,adultsCount,childrenCount,specialCareCount,refundAmount} = item;
          const refundableDate = new Date(startDate);
          refundableDate.setDate(refundableDate.getDate() + refundableTill);
          return (
              ...
              <div className="mybooking-tab bg-white rounded-radius">
                ...
                >
                  <div className="img-left-box">
                    <Image src={item?.primaryImage?.url} alt="hotel image" height={62} width={62}></Image>
                  </div>
                ...
                <div className="text-room-category">
                  ...
                  {isDateChangeAvailable &&   
                  <span className="green-text">
                 {` Free Date Change Avilable till ${formatDate(refundableDate?.toISOString().split('T')[0],false,false)}`}
                </span>
                }                  
                </div>
                <div className="list-contact">
                  <ul className="d-flex align-items-center gap-2 justify-content-center">
                    ...
                    <div className="cursor-pointer">
                      <div className="list-contect-box">
                      <NeedHelp item={item.hostDetails} />
                  ...
                  <div className="pay-btn-box">
                    <ul>
                      ...
                      {paymentStatus !== "PAID" && (
                        <li>
                          <Link
                            href={`/home/accommodation/booking/${item.hotelId}/booknow`}
                            className="btn btn-primary"
                            // onClick={ dispatch(setMyBooking(item))}
                          >
