...
import { resetFilters, setRangeFilter, setSingleFilter, toggleArrayFilter} from "@//store/features/accommodation/slices/selectedFilterSlice";
    ...
    <div className="filter-sec sec-gap">
      <div className="d-flex align-items-center justify-content-between px-40">
        <div className="inner-filter-sec position-relative">
          ...
          >
            {bookingOptions?.length>0 && bookingOptions.map((item:any) => (
