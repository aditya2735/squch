...
const TrendingDestination = () => {
  ...
  const SwiperRows = (data: any, index: number) => { 
    return (
      <SwiperSlide key={index}>
        <div className="slider-trending-box position-relative">
        <Image
            src={data.img.src ? data.img.src : data.img}
            alt="Image"
          ...
          <div className="text-slider-trending-box">
            ...
            <p className="d-flex align-items-center gap-1">
              Price <span className="text-big-text"> ₵ </span>{" "}
    ...
    <div className="trending-slider-sec">
      <div className="px-40">
        ...
        <div className=" position-relative">
          ...
          >
            {TrendingStaysData.map((data, index) =>
              SwiperRows(data, index + 1)
            )}
