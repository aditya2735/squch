...
const KunasiSquchStay = () => {
  const { popular: PopularStays } = useAppSelector(
    (state) => state.homeHotels.data
  );

  return (
    <div className="ghana-squch-sec px-40 pt-4 pb-5">
      <div className="block-header">
        <div className="d-flex align-item-center">
          <h2 className="heading02 m-0">Kunasi</h2>
        </div>
      </div>
      <div className="ghana-squch-slider">
        ...
        >
          {/* {PopularStays?.length > 0 &&
            PopularStays.map((hotel: any) => {
              return SwiperRows(hotel, "Wishlist");
            })} */}
          {/* <SwiperSlide>
...
export default KunasiSquchStay;
