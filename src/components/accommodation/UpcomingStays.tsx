...
const UpcomingStays = ({latestBookingData:item}:{latestBookingData:MyBooking}) => {
    ...
    return (
        ...
        <div className='upcoming-stays-sec sec-gap pt-0'>
        <div className='px-40'>
            <div className="heading-top d-md-block d-none">
                <div className="img-blind">
                    <Image src={TopImg} alt="" className="w-100"/>
                </div>
                <div className='text-center text-mid-heading'>
                    <h2 className="mb-0">Upcoming Stays</h2>
                </div>
            </div>
            <div className='bg-white position-relative bottom-upcoming'>
                <div className='com-bottom-upcoming d-flex flex-wrap align-items-center gap-4'>
                    <div className='img-left-side d-flex align-items-center gap-3'>
                    <div className="img-left-side-mobile">
                                <Image  src={item?.primaryImage?.url} alt="hotel image" className="w-100"
                                width={300}
                                height={212}
                                />
                            </div>
                        <div className='text-bottom-upcoming-box d-lg-none d-block mobile-text-box'>
                            <div className='d-flex flex-wrap gap-3'>
                                <div className='left-upcoming-box w-100'>
                                <h3>{name}</h3>
                    ...
                    <div className='text-bottom-upcoming-box'>
                        <div className='d-flex flex-wrap gap-3'>
                            <div className='left-upcoming-box '>
                                <div className="d-lg-block d-none">
                                <h3>{name}</h3>
                                <p className='text-mid-small'> 
                               {getDateNGuest(startDate, endDate, adultsCount, childrenCount, specialCareCount)}</p>
                               <p> {address} {city}, {state}, {country} </p>
                                </div>
                                <ul className='d-flex align-items-center justify-content-center xl:gap-4 gap-3 mb-lg-0 mb-md-3 mt-lg-0 mt-md-3  icons-text-box '>
                                    <li>
                                        <Link href="">
                                            <i className='icons'>
                                                <svg width="25" height="24" viewBox="0 0 25 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                    <path d="M8.89453 2V5" stroke="#262626" strokeWidth="1.5" stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round" />
                                                    <path d="M16.8945 2V5" stroke="#262626" strokeWidth="1.5" stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round" />
                                                    <path d="M4.39453 9.08997H21.3945" stroke="#262626" strokeWidth="1.5" stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round" />
                                                    <path d="M22.8945 19C22.8945 19.75 22.6845 20.46 22.3145 21.06C21.6245 22.22 20.3545 23 18.8945 23C17.8845 23 16.9645 22.63 16.2645 22C15.9545 21.74 15.6845 21.42 15.4745 21.06C15.1045 20.46 14.8945 19.75 14.8945 19C14.8945 16.79 16.6845 15 18.8945 15C20.0945 15 21.1645 15.53 21.8945 16.36C22.5145 17.07 22.8945 17.99 22.8945 19Z" stroke="#262626" strokeWidth="1.5" stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round" />
                                                    <path d="M17.3345 19L18.3245 19.99L20.4545 18.02" stroke="#262626" strokeWidth="1.5" stroke-linecap="round" stroke-linejoin="round" />
                                                    <path d="M21.8945 8.5V16.36C21.1645 15.53 20.0945 15 18.8945 15C16.6845 15 14.8945 16.79 14.8945 19C14.8945 19.75 15.1045 20.46 15.4745 21.06C15.6845 21.42 15.9545 21.74 16.2645 22H8.89453C5.39453 22 3.89453 20 3.89453 17V8.5C3.89453 5.5 5.39453 3.5 8.89453 3.5H16.8945C20.3945 3.5 21.8945 5.5 21.8945 8.5Z" stroke="#262626" strokeWidth="1.5" stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round" />
                                                    <path d="M12.89 13.7H12.899" stroke="#262626" strokeWidth="2" stroke-linecap="round" stroke-linejoin="round" />
                                                    <path d="M9.18884 13.7H9.19783" stroke="#262626" strokeWidth="2" stroke-linecap="round" stroke-linejoin="round" />
                                                    <path d="M9.18884 16.7H9.19783" stroke="#262626" strokeWidth="2" stroke-linecap="round" stroke-linejoin="round" />
                                                </svg>
                                    ...
                                    <li>
                                    <Link href={`/home/accommodation/needHelp/${item.hostDetails.id}`}
                                           onClick={() => dispatch(setMyBooking(item.hostDetails))}
                                            >
                                            <i className='icons'>
                                                <svg width="25" height="24" viewBox="0 0 25 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        ...
                                        <div className='d-flex align-items-center gap-1'>
                                            ...
                                            <span className='dropdown-icons'>
                                                <svg width="13" height="7" viewBox="0 0 13 7" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                    <path d="M11.3945 6L6.39453 1L1.39453 6" stroke="#262626" strokeWidth="1.5" stroke-linecap="round" stroke-linejoin="round" />
                                                </svg>
                ...
                <div className='bottom-btn-mid'>
                    <div className="bottom-btn-box">
                        <button className='btn btn-primary'>
                        {` Pay ${getCurrencySymbol(item?.currency)}${item?.calculatedPrice} now`}
                        </button>
                    </div>
                </div>
            </div>
