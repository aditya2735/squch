...
const SimilarPropertiesNearby = ({ similarData }: { similarData: Hotel[] }) => {
  return (
    <>
        ...
        <div className="block-header">
          <div className="d-flex align-item-center">
            ...
            <div className="ms-auto">
              <Link href="/home/accommodation/seeAll/similarProperty" className="link">
                See All
                <svg
                  width="12"
                  height="12"
        ...
        <div className="you-might-also-slider">
          ...
          >
            {similarData?.length > 0 &&
              similarData.map((hotel, index: number) => {
                return (
