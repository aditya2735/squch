...
const SimilarPropertiesNearby = () => {
  ...
  const SwiperRows = (hotelImages: Array<any>, index: number) => {
    return (
      <SwiperSlide key={index}>
        <div className="position-relative multislider-com-box">
          <div className="top-slider position-relative">
            ...
            >
              {hotelImages.map((hotelImage: any, index) => ( 
                  <SwiperSlide key={index}>
                      ...
                      <div className="">
                        <div className="position-relative"
                          ...
                          <div className="img-box">
                            <Image
                              src={hotelImage.src ? hotelImage.src : hotelImage}
                              alt={hotelImage.src ? hotelImage.src : hotelImage}
                              height={180}
                              width={293}
        ...
        <div className='you-might-also-sec mb-24'>
            <div className='block-header'>
              <div className='d-flex align-item-center'>
                <h2 className='heading02 m-0'>Similar properties nearby</h2>
                <div className='ms-auto'>
                  <Link href="/home/accommodation/seeAll/nearBy" className='link'>
                    See All
          ...
          >
             {hotels?.length > 0 &&
                ...
                return SwiperRows(hotel.img, index);
                })}
...
export default SimilarPropertiesNearby