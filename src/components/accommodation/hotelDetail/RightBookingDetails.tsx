...
const RightBookingDetails = () => {
  ...
  // const [selectedRoom, setSelectedRoom] =  useState<string>("Classic Room 1");
        ...
        <div className="top-booking-details bg-white mb-4">
          ...
          <div className="list-booking">
            <ul className="d-flex align-items-center gap-3 justify-content-between">
              ...
              <li className="date-box">Wed,8 Jan - Thus, 9 Jan</li>
            </ul>
            <ul className="d-flex align-items-center gap-3 justify-content-between">
              <li className="time-box d-flex align-items-center gap-2">
                <span>
              ...
              <li className="date-box">2 Guests - 1 Night</li>
            </ul>
            <ul className="d-flex align-items-center gap-3 justify-content-between">
              <li className="time-box d-flex align-items-center gap-2">
                <span>
              ...
              <li className="date-box">1 Adult, 1 Children</li>
            </ul>
          </div>
          <div className="light-bg-top-booking">
            <div className="dropdown-room">
              <Dropdown
                  onSelect={(eventKey) => {
                    const selected = rooms.find((room:any) => room.id.toString() === eventKey);
                    if (selected) {
            ...
            <div className="book-now-btn">
              <div
                ...
                onClick={() => router.push(`/home/accommodation/payment`)}
              >
                {" "}
                Book Now{" "}
              </div>
