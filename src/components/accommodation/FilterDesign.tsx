...
const FilterDesign = () => {
  return (
    <div className='filterDesign-sec'>
        <div className='container'>
            <div className='inner-filterdesign'>
                <ul className="com-slider-box d-flex align-items-center gap-3 ">
                    ...
                    <li>
                        <Link className="slider-box d-flex align-items-center gap-2 active-filter" href="">
                            Cuisines
                            <svg width="18" height="18" viewBox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M5.25 7.5L9 11.25L12.75 7.5" stroke="#652669" strokeWidth="1.125" strokeLinecap="round" strokeLinejoin="round"/></svg>
                        </Link>
                    </li>
                    <li>
                        <Link className="slider-box d-flex align-items-center gap-2 active-filter" href="">
