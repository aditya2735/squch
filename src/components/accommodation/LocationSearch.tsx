          ...
          <ul className="location-listing-box w-100 d-flex flex-wrap align-items-center">
            ...
            <li className="location-fourth-box">
              ...
              <li className="location-fifth-box">
                  {/* Search Button */}
                <div className="flex">
                  <button onClick={()=>router.push("/home/accommodation/search")}>
                    <svg
                      width="48"
                      height="48"
                      viewBox="0 0 48 48"
