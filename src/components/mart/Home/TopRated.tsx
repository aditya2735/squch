...
const TopRated: React.FC<TopRatedProps> = ({ stores }) => {
                                        ...
                                        <div className="topratedyou-box">
                                            <div className="topratedyou-item" >
                                                <div className="img-box position-relative">
                                                    ...
                                                    <img src={'https://res.cloudinary.com/ddlloxt3o/image/upload/v1738326294/Squch/wj8tkfsdm7q0koistmtv.png'} alt="" />

                                                    <div className="icons-img" onClick={(event) => {
