...
const TopRatedYou = () => {
  return (
    <div className='topRatedYou sec-gap'>
        <div className='container'>
            <div className='innerTopRatedYou'>
                <div className='block-header'>
                  <div className='d-flex align-item-center'>
                    <h2 className='heading02 m-0'>Discover best restaurants on Dineout</h2>
